...
STATUS dtlsTransmissionTimerCallback(UINT32 timerID, UINT64 currentTime, UINT64 customData)
{
    ...
    acquireDtlsSession(pDtlsSession, "Timer callback");
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "Timer callback");
    return retStatus;
}
                         ...
                         BOOL generateRSACertificate, PRtcCertificate pRtcCertificates, PDtlsSession* ppDtlsSession)
{
    ...
    PROFILE_CALL(CHK_STATUS(createSslCtx(certInfos, pDtlsSession->certificateCount, &pDtlsSession->pSslCtx)), "SSL CTX creation time");
    PROFILE_CALL(CHK_STATUS(createSsl(pDtlsSession->pSslCtx, &pDtlsSession->pSsl)), "SSL creation time");
...
STATUS dtlsSessionStart(PDtlsSession pDtlsSession, BOOL isServer)
{
    ...
    acquireDtlsSession(pDtlsSession, "Session start");
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "Session start");
...
STATUS dtlsSessionHandshakeStart(PDtlsSession pDtlsSession, BOOL isServer)
{
    ...
    acquireDtlsSession(pDtlsSession, "Handshake start");
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "Handshake start");
...
STATUS dtlsSessionProcessPacket(PDtlsSession pDtlsSession, PBYTE pData, PINT32 pDataLen)
{
    ...
    acquireDtlsSession(pDtlsSession, "Process packet");
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "Process packet");
...
STATUS dtlsSessionPutApplicationData(PDtlsSession pDtlsSession, PBYTE pData, INT32 dataLen)
{
    ...
    acquireDtlsSession(pDtlsSession, "Put data");
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "Put data");
...
STATUS dtlsSessionShutdown(PDtlsSession pDtlsSession)
{
    ...
    acquireDtlsSession(pDtlsSession, "Shutdown");
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "Shutdown");
...
STATUS dtlsCheckOutgoingDataBuffer(PDtlsSession pDtlsSession)
{
    ...
    // This retrieves the write buffer associated with the DTLS session
...
STATUS dtlsSessionIsInitFinished(PDtlsSession pDtlsSession, PBOOL pIsConnected)
{
    ...
    acquireDtlsSession(pDtlsSession, "Init finished");
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "Init finished");
...
STATUS dtlsSessionPopulateKeyingMaterial(PDtlsSession pDtlsSession, PDtlsKeyingMaterial pDtlsKeyingMaterial)
{
    ...
    acquireDtlsSession(pDtlsSession, "key mat");
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "key mat");
    LEAVES();
    return retStatus;
}
...
STATUS dtlsSessionGetLocalCertificateFingerprint(PDtlsSession pDtlsSession, PCHAR pBuff, UINT32 buffLen)
{
    ...
    acquireDtlsSession(pDtlsSession, "LCF");
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "LCF");
...
STATUS dtlsSessionVerifyRemoteCertificateFingerprint(PDtlsSession pDtlsSession, PCHAR pExpectedFingerprint)
{
    ...
    acquireDtlsSession(pDtlsSession, "RCF");
    MUTEX_LOCK(pDtlsSession->sslLock);
    locked = TRUE;
...
CleanUp:
    ...
    releaseDtlsSession(pDtlsSession, "RCF");
